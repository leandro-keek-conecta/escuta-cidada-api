...
export interface IFormResponseRepository {
  ...
  ListMetricsByProject(projectId: number): Promise<FormResponse[]>;
  update(id: number,data: Prisma.FormResponseUpdateInput): Promise<FormResponse>;
  delete(id: number): Promise<void>;
  listByProjectId(params: ListFormResponsesByProjectInput): Promise<FormResponseWithForm[]>;
}
